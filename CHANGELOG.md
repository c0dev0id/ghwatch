...
- `--discover` flag: queries GitHub Actions for the last successful run of each workflow and lists the artifacts it produced with sizes; prints `--artifact` values ready to copy-paste
